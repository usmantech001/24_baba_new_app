  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomNavigationBar: Container(
        ...
        child: AppButton(isLoading: false, onPressed: (){
            ...
            SliverAppBar(
              ...
              title: AnimatedOpacity(
                ...
                child: Padding(
                  ...
                  child: CustomText(text: 'Rent Nissan Patrol in Dubai',fontSize: 20.sp,
                            fontWeight: FontWeight.bold, maxLines: 2, color: AppColors.kWhite,),
                ),
              ),
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                CustomText(text: 'Hosted by', color: AppColors.kGrey,),
                                CustomText(text: 'Ali Ahmad', fontWeight: FontWeight.bold,),
                              ],
                            )
                          ],
                        ),
...
class DetailsTabView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        CustomText(text: 'Basic Info', fontSize: 20.sp, fontWeight: FontWeight.bold,)
      ],
    );
  }
}